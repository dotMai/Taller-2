...
public class SandboxArreglos
{
    ...
    public int[] buscarEntero( int valor )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++) {
            if (arregloEnteros[i] == valor) {
                posiciones = ampliarYAgregar(posiciones, i);
            }
        }
        return posiciones;
    }
    ...
    /**
     * Método auxiliar para ampliar un arreglo y agregar un nuevo elemento al final.
     */
    private int[] ampliarYAgregar(int[] arreglo, int nuevoElemento) {
        int[] nuevoArreglo = new int[arreglo.length + 1];

        // Copiamos los elementos existentes al nuevo arreglo
        System.arraycopy(arreglo, 0, nuevoArreglo, 0, arreglo.length);

        // Agregamos el nuevo elemento al final del nuevo arreglo
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        HashMap<Integer, Integer> frecuenciaThis = calcularFrecuencia(arregloEnteros);
        HashMap<Integer, Integer> frecuenciaOther = calcularFrecuencia(otroArreglo);
        return frecuenciaThis.equals(frecuenciaOther);
    }
    /**
     * Método auxiliar para calcular la frecuencia de cada valor en un arreglo.
     */
    private HashMap<Integer, Integer> calcularFrecuencia(int[] arreglo) {
