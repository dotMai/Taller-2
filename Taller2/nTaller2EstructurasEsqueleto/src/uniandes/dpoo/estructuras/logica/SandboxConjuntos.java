...
public class SandboxConjuntos
{
    ...
    public Collection<String> getSiguientes( String cadena )
    {
        ...
        Collection<String> siguientesCadenas = new ArrayList<>(subconjunto);
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        arbolCadenas.remove(cadenaEnMinusculas);
    }
    ...
    {
    	TreeSet<String> conjuntoInvertido = new TreeSet<String>(Comparator.reverseOrder());
